...
doc_events = {
	...
	"Stock Entry": {
		...
		"on_submit":["erpnext.stock.doctype.material_request.material_request.update_completed_qty","erpnext.stock.custom_methods.generate_serial_no_fg","erpnext.stock.custom_methods.update_stock_name"],
